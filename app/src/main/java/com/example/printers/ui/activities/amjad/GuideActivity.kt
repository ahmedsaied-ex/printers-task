...
import com.example.printers.ui.activities.amjad.LoginActivity
import com.example.printers.ui.adapter.amjad.onBoarding.ViewPagerAdapter
...
*/
    ...
    private fun savePrefrances(){
        sharedPrefs.write(MyConstants.IS_FIRST_TIME_LAUNCH, false)
        Log.d("GuideActivity_LOG", "savePrefrances")
    }

    private fun isFirstTime(): Boolean {
        return sharedPrefs.read(MyConstants.IS_FIRST_TIME_LAUNCH, true)
    }

    private fun initViews() {
        binding = ActivityGuideBinding.inflate(layoutInflater)
        sharedPrefs = SharedPrefs.Companion.getInstance(applicationContext);
